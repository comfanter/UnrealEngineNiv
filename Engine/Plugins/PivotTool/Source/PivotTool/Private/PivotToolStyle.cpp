...
// #define HOVER_COLOR( Color ) Color * 1.5f
// #define PRESS_COLOR( Color ) Color * 0.8f
...
void FPivotToolStyle::SetupStyles(FSlateStyleSet* Style)
{
	...
	//const FLinearColor ColorDarkGray(47/255.f, 47/255.f, 47/255.f, 1.0f);
	...
	// TextStyle
	{
		...
		Style->Set("PivotTool.CheckboxText", FTextBlockStyle()
			.SetFont(TTF_FONT("Fonts/DroidSansMono", 8))
			.SetColorAndOpacity(FLinearColor(1.0f, 1.0f, 1.0f))
			.SetHighlightColor(FLinearColor(1.0f, 1.0f, 1.0f)));
		// 			.SetShadowOffset(FVector2D(1, 1))
	...
	// Button Style
	{
		...
		// 		Style->Set("PivotTool.ButtonStyle.PivotCenter", FButtonStyle()
		// 			.SetNormal(IMAGE_BRUSH("Images/button_pivot_center", Image30x30, ColorPivotCenter))
